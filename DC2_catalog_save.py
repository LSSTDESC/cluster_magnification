...
if halo == "True":
    ...
    gal_selection = extragalactic_cat.get_quantities(['mag_u_lsst', 'mag_g_lsst', 'mag_r_lsst', 'mag_i_lsst', 'mag_z_lsst', 'mag_y_lsst', 'redshift','ra', 'dec', 'shear_1', 'shear_2', 'convergence'], filters=filters)
    ...
    LBGp =  LBGp = (u_min_g > 0.33 * r_min_i + 0.87) *(r_min_i<0.05)  * (g_min_r<0.6)
